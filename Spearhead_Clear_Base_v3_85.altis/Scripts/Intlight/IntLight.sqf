...
systemChat "Innenraumlicht wird geladen...";
...
IL_text_ON = "<t color='#FF0000'>Innenraumlicht EIN schalten</t>";
IL_text_OFF = "<t color='#FF0000'>Innenraumlicht AUS schalten</t>";
IL_Green_Text = "<t color='#00FF00'>Lichtfarbe ändern in Grün</t>";
IL_Red_Text = "<t color='#FF0000'>Lichtfarbe ändern in Rot</t>";
IL_action = -1;
...
IL_Loaded = true;
diag_log "IL ready";
systemChat "Innenraumlicht wurde geladen!";